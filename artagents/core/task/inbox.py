...
that an attested step has completed. ``artagents next`` consumes these
...
from artagents.core.task.active_run import clear_active_run
...
_LOGGER = logging.getLogger("artagents.core.task.inbox")
