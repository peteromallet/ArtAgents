"""Walk artagents/packs/*/skill/SKILL.md and yield SkillDescriptors.
...
from artagents.core._search import short_description_or_truncated

PACKS_DIR = REPO_ROOT / "artagents" / "packs"
