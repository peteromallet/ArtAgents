...
def _write_candidate_contact_sheet(candidates: list[dict[str, Any]], out_path: Path) -> dict[str, Any]:
    ...
    try:
        from .visual_understand import _build_contact_sheet
...
def _load_or_create_shots(
    ...
    from . import shots as shots_module
...
def _run_visual_selection(
    ...
    if not candidates:
        return None
    try:
        from . import visual_understand
        from .generate_image import load_api_key
