...
ALIASES: dict[str, str | Callable[[list[str]], int]] = {
    "audio": "artagents.packs.builtin.audio_understand.run:main",
    "image": "artagents.packs.builtin.visual_understand.run:main",
    "visual": "artagents.packs.builtin.visual_understand.run:main",
    "video": "artagents.packs.builtin.video_understand.run:main",
}
