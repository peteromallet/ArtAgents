...
python3 -m artagents.packs.builtin.understand.run --mode image --image frame.jpg
python3 -m artagents.packs.builtin.understand.run --mode audio --audio clip.wav
python3 -m artagents.packs.builtin.understand.run --mode video --video source.mp4 --at 01:20
```
