...
```bash
python3 -m artagents executors inspect builtin.tile_video --json
```

Run:

```bash
python3 -m artagents executors run builtin.tile_video \
...
```bash
python3 -m artagents.packs.builtin.tile_video.run \
