...
```bash
python3 -m artagents executors inspect external.fal_foley --json
```

Run:

```bash
python3 -m artagents executors run external.fal_foley \
...
```bash
python3 -m artagents.packs.external.fal_foley.run \
