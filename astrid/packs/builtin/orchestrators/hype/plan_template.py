...
def _build_transcribe_cmd(
    ...
    return (
        f"{python_exec} -m astrid.packs.builtin.executors.transcribe "
...
def _build_scenes_cmd(python_exec: str, run_root: Path) -> str:
    ...
    return (
        f"{python_exec} -m astrid.packs.builtin.executors.scenes "
...
def _build_cut_cmd(python_exec: str, run_root: Path) -> str:
    ...
    return (
        f"{python_exec} -m astrid.packs.builtin.executors.cut "
...
def _build_validate_cmd(python_exec: str, run_root: Path) -> str:
    ...
    return (
        f"{python_exec} -m astrid.packs.builtin.executors.validate "
