...
Usage:
  ...
  python3 -m astrid packs {validate,new,install,list,inspect,update,uninstall,rollback,agent-index} ...
...
Install and manage packs:
  python3 -m astrid packs install <path-or-git-url>
  python3 -m astrid packs list
  python3 -m astrid packs inspect <id>
  python3 -m astrid packs update <id>
  python3 -m astrid packs uninstall <id>
  python3 -m astrid packs rollback <id>
