"""minimal.ingest_assets — executor runtime entrypoint.
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    # Count files in source (minimal stub)
    if source.is_dir():
        files = list(source.iterdir())
        print(f"ingest_assets: found {len(files)} items in source")
