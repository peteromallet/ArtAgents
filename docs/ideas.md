...
- A single image from a prompt — `builtin.generate_image`
- A portrait of yourself as Saint Peter of Banodoco — `python3 -m artagents.packs.builtin.generate_image.run --preset saint-peter-of-banodoco --out-dir runs/first-rite/images --manifest runs/first-rite/manifest.json --force`
