...
- A portrait of yourself as Saint Peter of Banodoco — `python3 -m artagents.executors.generate_image.run --preset saint-peter-of-banodoco --out-dir runs/first-rite/images --manifest runs/first-rite/manifest.json --force`
